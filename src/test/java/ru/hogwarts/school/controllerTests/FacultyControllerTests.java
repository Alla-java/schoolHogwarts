...
public class FacultyControllerTests {
    ...
    public void testGetFacultyStudents() {
        ...
        newStudent1.setFaculty(faculty);
        newStudent2.setFaculty(faculty);

        // Сохраняем студентов в репозитории
        restTemplate.exchange(
                "/student", HttpMethod.POST, new HttpEntity<>(newStudent1), Student.class);
        restTemplate.exchange(
                "/student", HttpMethod.POST, new HttpEntity<>(newStudent2), Student.class);
